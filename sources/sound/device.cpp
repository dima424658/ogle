...
CDevice::CDevice()
{
    ...
    m_system->getChannel(0, &m_channel);
...
unsigned int CDevice::GetVersion()
{
    return m_version;
}

FMOD::System* CDevice::GetSystem()
{
    return m_system;
}


FMOD::Channel* CDevice::GetChannel()
{
    return m_channel;
}
...
const char* Sound::Error(FMOD_RESULT errcode)
{
    switch (errcode)
    {
